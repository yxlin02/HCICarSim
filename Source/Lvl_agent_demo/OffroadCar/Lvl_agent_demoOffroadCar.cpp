...
#include "Lvl_agent_demoOffroadCar.h"
#include "Lvl_agent_demoOffroadWheelFront.h"
#include "Lvl_agent_demoOffroadWheelRear.h"
...
ALvl_agent_demoOffroadCar::ALvl_agent_demoOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = ULvl_agent_demoOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = ULvl_agent_demoOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = ULvl_agent_demoOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = ULvl_agent_demoOffroadWheelRear::StaticClass();
