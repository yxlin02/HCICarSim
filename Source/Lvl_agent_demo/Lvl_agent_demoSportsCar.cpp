...
#include "Lvl_agent_demoSportsCar.h"
#include "Lvl_agent_demoSportsWheelFront.h"
#include "Lvl_agent_demoSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ALvl_agent_demoSportsCar::ALvl_agent_demoSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = ULvl_agent_demoSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = ULvl_agent_demoSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = ULvl_agent_demoSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = ULvl_agent_demoSportsWheelRear::StaticClass();
