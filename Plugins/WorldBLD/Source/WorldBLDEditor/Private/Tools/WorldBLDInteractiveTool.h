...
#include "WorldBLDInteractiveTool.generated.h"


/**
 * Builder for UWorldBLDInteractiveTool
 */
UCLASS()
class WORLDBLDEDITOR_API UWorldBLDInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UWorldBLDInteractiveTool
 */
UCLASS(Transient)
class WORLDBLDEDITOR_API UWorldBLDInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UWorldBLDInteractiveToolProperties();
...
/**
 * UWorldBLDInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class WORLDBLDEDITOR_API UWorldBLDInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UWorldBLDInteractiveToolProperties> Properties;
