...
#include "WorldBLDInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UWorldBLDInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UWorldBLDInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UWorldBLDInteractiveTool* NewTool = NewObject<UWorldBLDInteractiveTool>(SceneState.ToolManager);
...
UWorldBLDInteractiveToolProperties::UWorldBLDInteractiveToolProperties()
{
...
void UWorldBLDInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UWorldBLDInteractiveTool::Setup()
{
	...
	Properties = NewObject<UWorldBLDInteractiveToolProperties>(this, "Measurement");
...
void UWorldBLDInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UWorldBLDInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UWorldBLDInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UWorldBLDInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UWorldBLDInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UWorldBLDInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UWorldBLDInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UWorldBLDInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UWorldBLDInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
